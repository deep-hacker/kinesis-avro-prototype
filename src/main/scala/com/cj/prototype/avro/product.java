...
public class product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -555367633663339827L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"product\",\"namespace\":\"com.cj.prototype.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public product(java.lang.Integer id, java.lang.CharSequence name, java.lang.Double price, java.lang.Integer quantity) {
    this.id = id;
    this.name = name;
    this.price = price;
   ...
   */
  public static com.cj.prototype.avro.product.Builder newBuilder() {
    return new com.cj.prototype.avro.product.Builder();
  }
   ...
   * @return A new product RecordBuilder
   */
  public static com.cj.prototype.avro.product.Builder newBuilder(com.cj.prototype.avro.product.Builder other) {
    if (other == null) {
      return new com.cj.prototype.avro.product.Builder();
    } else {
      return new com.cj.prototype.avro.product.Builder(other);
    }
  }
   ...
   * @return A new product RecordBuilder
   */
  public static com.cj.prototype.avro.product.Builder newBuilder(com.cj.prototype.avro.product other) {
    if (other == null) {
      return new com.cj.prototype.avro.product.Builder();
    } else {
      return new com.cj.prototype.avro.product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cj.prototype.avro.product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cj.prototype.avro.product other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cj.prototype.avro.product.Builder clearQuantity() {
